    ...
    <layout title="Proyek" subtitle="Lokasi">
        <div>
            ...
            <div class="card">
                ...
                <DataTable :value="dataLokasi.data" :lazy="true" :paginator="true" :rows="5" v-model:filters="filters"
                    ref="dt" :totalRecords="dataLokasi.total" :loading="loading" @page="onPage($event)"
                    ...
                    <Column :exportable="false">
                        <template #body="slotProps">
                            <Button icon="pi pi-pencil" class="p-button-rounded p-button-success p-mr-2"
                                @click="editProduct(slotProps.data)" style="margin-right: 10px;" />
